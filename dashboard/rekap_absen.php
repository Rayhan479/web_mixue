...
<body class="d-flex h-100 text-center text-bg-dark">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        <header class="mb-auto">
            <div>
                <h3 class="float-md-start mb-0 absensi">RIWAYAT ABSENSI PEGAWAI</h3>
                ...
                <nav class="nav nav-masthead justify-content-center float-md-end">
                    ...
                    <a class="nav-link fw-bold py-2 px-2 active" aria-current="page" href="rekap_absen.php">Riyawat Absen</a>
                    <a class="nav-link fw-bold py-2 px-2" aria-current="page" href="profile.php">Profile</a>
