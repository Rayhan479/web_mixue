<table class="table table-striped table-dark table-hover">
    ...
    // Mengambil satu baris terbaru berdasarkan tanggal dan waktu masuk
    $sql = "SELECT * FROM attendances WHERE employee_id = $employee_id ORDER BY tgl DESC, clock_in DESC LIMIT 1";
    $result = $db->query($sql);
